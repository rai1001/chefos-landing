...
const IconBox = () => (
  <svg className="w-6 h-6 text-[#FF7A00]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
);

export function FeaturesBento() {
  return (
    <section className="py-24 px-4 relative z-10 w-full flex flex-col items-center">
      <div className="max-w-7xl mx-auto w-full space-y-32">
        
        {/* BLOQUE 1: Conoce a CLARA (La joya de la corona) */}
        <div className="w-full">
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold tracking-widest text-[#FF7A00] uppercase mb-3">Inteligencia Autónoma</h2>
            <h3 className="text-4xl md:text-6xl font-serif text-white leading-tight">
              Conoce a CLARA. <br className="hidden md:block"/>Tu Agente de Facturación.
            </h3>
            <p className="mt-6 text-xl text-neutral-400 max-w-2xl mx-auto font-sans font-light">
              No es un OCR glorificado. Es una empleada incansable que gestiona tus compras de principio a fin usando Gemini Vision.
            </p>
          </div>

          <div className="bg-[#111111]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-8 md:p-12 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#FF7A00]/10 rounded-full blur-[100px] pointer-events-none group-hover:bg-[#FF7A00]/20 transition-all duration-700"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
              <div className="space-y-8">
                <div className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 backdrop-blur-md">
                  ...
                  <span className="text-xs font-mono text-neutral-300">CLARA está activa</span>
                </div>
                ...
                <ul className="space-y-6">
                  {Object.entries([
                    ...
                    <li key={i} className="flex items-start space-x-4">
                      <div className="mt-1 bg-[#FF7A00]/20 p-2 rounded-full">
                        <svg className="w-4 h-4 text-[#FF7A00]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                      </div>
              ...
              <div className="bg-black/50 border border-white/10 rounded-2xl p-6 font-mono text-sm text-neutral-400 shadow-2xl">
                ...
                <div className="space-y-3">
                  ...
                  <p><span className="text-purple-400">CLARA</span>: Extrayendo líneas con Gemini Vision...</p>
                  <p><span className="text-purple-400">CLARA</span>: Comparando albarán #882... <span className="text-green-400">MATCH!</span></p>
                  <p><span className="text-yellow-400">WARN</span>: Discrepancia del +3% en Tomate Raf.</p>
                  <p><span className="text-purple-400">CLARA</span>: Redactando email de reclamación automático a Frutas Pepe SL...</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-[#111111]/40 backdrop-blur-md border border-white/5 hover:border-[#FF7A00]/50 transition-colors duration-500 rounded-2xl p-8 group">
                <div className="mb-4 bg-white/5 inline-block p-3 rounded-xl group-hover:bg-[#FF7A00]/10 transition-colors">
                  {engine.icon}
                </div>
        ...
        <div className="w-full bg-gradient-to-b from-[#0A0A0A] to-[#050505] rounded-[40px] border border-white/5 p-8 md:p-16">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12">
            ...
            <div className="space-y-12">
              <div className="space-y-4">
                <h4 className="text-2xl font-bold text-white flex items-center"><span className="text-[#FF7A00] mr-3">01.</span> Multilocal & Control</h4>
              ...
              <div className="space-y-4">
                <h4 className="text-2xl font-bold text-white flex items-center"><span className="text-[#FF7A00] mr-3">02.</span> Compras & Stock FIFO</h4>
              ...
              <div className="space-y-4">
                <h4 className="text-2xl font-bold text-white flex items-center"><span className="text-[#FF7A00] mr-3">03.</span> Etiquetado Inteligente</h4>
            ...
            <div className="space-y-12">
              <div className="bg-[#111] border border-white/10 rounded-2xl p-8 relative overflow-hidden">
                <div className="absolute -right-4 -top-4 w-24 h-24 bg-[#FF7A00]/20 rounded-full blur-2xl"></div>
              ...
              <div className="bg-[#111] border border-white/10 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="border border-white/5 rounded-lg p-3 text-center">
                    <span className="block text-2xl font-bold text-[#FF7A00]">9</span>
                    <span className="text-xs text-neutral-500 uppercase tracking-wider">Roles Multi-Tenant</span>
                  </div>
                  <div className="border border-white/5 rounded-lg p-3 text-center">
                    <span className="block text-2xl font-bold text-[#FF7A00]">15+</span>
